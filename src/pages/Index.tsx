...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Hero Section */}
      <section className="pt-8 md:pt-16 pb-8 md:pb-12 hero-pattern">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-2xl md:text-5xl font-bold text-[#7779f5] mb-3 md:mb-6 px-2">
              Encontre Sua Próxima Oportunidade em Dados
            </h1>
            <p className="text-base md:text-lg text-[#1e293b]/80 mb-4 md:mb-8 px-4">
